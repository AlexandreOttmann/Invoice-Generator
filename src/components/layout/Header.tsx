...
const Header = () => {
 ...
 return (
  <nav className="shadow-sm mb-10    relative top-0 min-w-[32em] sm:w-full border-gray-200 px-2 sm:px-4 py-2.5 rounded">
    ...
    >
     <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ">
      <li>
       <Link
        to="/"
        className="block py-2 pl-3 pr-4 bg-blue-400 text-slate-900   hover:text-blue-400  rounded md:bg-transparent md:text-blue-700 md:p-0 "
        aria-current="page"
       >
        Home
       </Link>
