  ...
  <div className="z-10">
   <nav className="z-10 relative top-0 border-bottom-gray-200 px-2 py-2.5 rounded">
    <div className="container flex flex-wrap items-center justify-between mx-auto">
     ...
     <div
      className={`${visible} absolute top-10 md:static w-full -ml-3 md:block md:w-auto`}
      id="navbar-default"
     >
      <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ">
       <li>
        <Link
         onClick={toggle}
         to="/"
         className="block py-2 pl-3 pr-4 bg-blue-200 text-slate-900 hover:text-blue-300  rounded md:bg-transparent md:text-blue-300 md:p-0 "
         aria-current="page"
        >
         Home
        </Link>
